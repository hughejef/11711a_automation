...
def get_pools():
    ...
    cursor.execute("select PoolNumTxt from EzPool Where (PoolDt = '2023-10-24') and ProdCd in('G2F40S','G2F30S','G1F30S','G2F15S','G2F30HS','G2A05S') and Crawlsbit=0")
...
def generate_11711As():
    ...
    for warehouse in warehouse_pool_dict:
        ...
        while len(warehouse_pool_dict[warehouse]) > i :    
            ...
            reader = PdfReader(f'//Corp.lan/Shares/SecMktg/Ops/KC/Jeff/Blank11711As/11711A {warehouse} {i}.pdf')
            writer = PdfWriter()
